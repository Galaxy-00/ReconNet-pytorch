...
# %%
class ReconNet_M(nn.Module):
    def __init__(self, simpling_matrix, CS_ratio=25):
        super(ReconNet_M, self).__init__()
...
if __name__ == '__main__':
    ...
    recon = ReconNet_M(simpling_matrix, CS_ratio)
    ...
    # %%
    torch.save(recon.state_dict(), 'recon_m_{}.pkl'.format(CS_ratio))
